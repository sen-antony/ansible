...
```
cd existing_repo
git remote add origin https://gitlab.com/ansible1742810/user-acc-mgmt.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ansible1742810/user-acc-mgmt/-/settings/integrations)
